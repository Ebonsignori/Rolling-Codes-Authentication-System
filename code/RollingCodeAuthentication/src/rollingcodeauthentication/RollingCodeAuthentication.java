...
//    /* Old GUI for Rolling Code Authentication */
...
//                    Packet requestPacket = tx.getRequestPacket(true, true);
//                    System.out.println("Request Packet: ");
//                    System.out.println(requestPacket.toString());
//                    Packet responsePacket = reader.getResponsePacket(requestPacket, true, true);
